...
#
# Approach-1: Follow Approach-2 (simple)
...
def print_matrix_in_spiral(mat):
  ...
  while row_start <= row_end and col_start <= col_end:
    ...
    for c in range(col_start, col_end + 1):
      res.append(mat[row_start][c])

    # Top to down
    for r in range(row_start + 1, row_end + 1):
      res.append(mat[r][col_end])
...
def main():
  ...
  print(print_matrix_in_spiral(matrix))
  print(print_matrix_in_spiral_simple(matrix))
